$(function () {
    ...
    $(function(){
        $('#hotpoit,.hotsliede').mouseenter(function () {
            $('.hotsliede').stop(true, false).slideDown(500);
        })
        $('#hotpoit,.hotsliede').mouseleave(function () {
            $('.hotsliede').stop(true, false).slideUp(500);
        })
    });
